...
from services.group_member_services import (
    add_member_to_group,
    get_group_members,
    promote_member,
    remove_member,
...
def lambda_handler(event, context):
    ...
    try:
        ...
        if method == "POST":
            ...
            log_info("Member added to group for user_id: {}".format(current_user[0]))
        ...
        # GET MEMBERS
            ...
            log_info("Group members retrieved for user_id: {}".format(current_user[0]))
            ...
            log_info("Member promoted for user_id: {}".format(current_user[0]))
            ...
            log_info("Member deleted for user_id: {}".format(current_user[0]))
