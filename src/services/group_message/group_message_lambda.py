...
from common.logger.logger import log_error
    ...
    try:
        ...
        if method == "POST":
            ...
            if path.endswith("/read"):
                ...
                response = mark_message_as_read(group_id, message_id, current_user[0])
                ...
                result = {
                    ...
                    "read_at": (response[3].isoformat() if response[3] else None),
                }

                return success_response(
                    message="Message marked as read", data=result, status_code=200
                )
            else:
                ...
                return success_response(
                    ...
                    data={
                        ...
                        "message": response[3],
                        "created_at": (
                            response[6].isoformat() if response[6] else None
                        ),
                    },
                )
        ...
        # GET MESSAGES
            ...
            response = delete_group_message_service(
                group_id, message_id, current_user[0]
            )
